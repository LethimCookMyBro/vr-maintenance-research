    ...
    public sealed class LocalizedTaskBrief : MonoBehaviour
    {
        ...
        public void Refresh()
        {
            ...
            if (language == ResearchLanguage.Thai)
            {
                ...
                body.text = computer
                    ? "<b>อาการที่รายงาน</b>\nคอมพิวเตอร์เปิดไม่ติด\n\n<b>เป้าหมาย</b>\nระบุสาเหตุและดำเนินการซ่อมที่จำเป็นให้เสร็จสิ้น\n\n<b>แหล่งข้อมูล</b>\nอยู่ทางซ้ายของคุณ\n\nเมื่อเชื่อว่าเครื่องพร้อมแล้ว ให้กด <b>INSPECT</b>"
            ...
            if (language == ResearchLanguage.Japanese)
            {
                ...
                body.text = computer
                    ? "<b>報告された症状</b>\nコンピューターの電源が入りません。\n\n<b>目標</b>\n原因を特定し、必要な修理を完了してください。\n\n<b>情報源</b>\n左側にあります。\n\n装置の準備ができたと思ったら、<b>INSPECT</b> を押してください。"
                    : "<b>報告された症状</b>\n卓上扇風機が正常に動作しません。\n\n<b>目標</b>\n原因を特定し、必要な修理を完了してください。\n\n<b>情報源</b>\n左側にあります。\n\n装置の準備ができたと思ったら、<b>INSPECT</b> を押してください。";
                return;
            }
