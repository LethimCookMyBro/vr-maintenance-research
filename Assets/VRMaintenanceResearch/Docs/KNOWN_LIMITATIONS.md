...
- This is a graybox research-development prototype, not a validated learning intervention.
...
- Development researcher controls use IMGUI and are visible only in development mode.
...
- The eight invalid v1 information assets remain locally visible until a permitted Unity Editor deletion action is available; only `_v2` assets are used by task definitions.
